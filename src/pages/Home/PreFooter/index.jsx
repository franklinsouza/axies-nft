    ...
    <div className={styles.preFooter}>
      ...
      <div className={styles.preFooter__lineIcons}>
        <div>
          ...
          <h3 className={styles.preFooter__title}>
            Set Up Your Wallet
          </h3>
          <p className={styles.preFooter__text}>
            Wallet that is functional for NFT purchasing. You may have 
            a Coinbase account at this point, but very few are actually 
        ...
        <div>
          <div className={styles.preFooter__icon}>
            <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M38.9521 18H34.8961C33.2041 18 31.8481 19.38 31.8481 21.0732V25.164C31.8481 26.868 33.2041 28.2359 34.8961 28.2359H38.9521C40.6321 28.2359 42.0001 26.868 42.0001 25.164V21.0732C42.0001 19.38 40.6321 18 38.9521 18Z" fill="white" fillOpacity="0.4"></path>
          ...
          <p className={styles.preFooter__text}>
            Setting up your NFT collection and creating NFTs on NFTs is easy! 
            This guide explains how to set up your first collection
          </p>
        </div>
